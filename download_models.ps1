...
Write-Output "[+] Downloading Qwen 3.6 27B Heretic (The Heavyweight)..."
...
Write-Output "[+] Downloading Huihui 35B MoE (The Specialist Reasoning)..."
...
Write-Output "[+] Downloading GPT-OSS 20B NEO (The System Architect)..."
...
Write-Output "[+] Downloading SuperGemma 4 (The Ingestion Brain)..."
hf download mradermacher/supergemma4-e4b-abliterated-i1-GGUF --include "*Q4_K_M.gguf" --local-dir $MODEL_DIR
Write-Output "`n[!] All systems clear. Your 'Abliterated' fleet is ready for ignition."
